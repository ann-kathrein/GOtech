...
function btnListener(id) {
  changeColour(id);
  if (id === 'developerBtn') {
    for (let el of document.querySelectorAll('.designer, .mgmt'))
      el.style.display = 'none';
  } else if (id == 'designerBtn') {
    for (let el of document.querySelectorAll('.mgmt, .dev'))
      el.style.display = 'none';
  } else if (id == 'managementBtn') {
    for (let el of document.querySelectorAll('.dev, .designer'))
      el.style.display = 'none';
  } else if (id == 'allTogetherBtn') {
    for (let el of document.querySelectorAll('.dev, .designer, .mgmt'))
